...
public class Globals {
	...
	public static final String GC_EXTENT_CONFIG_LOC = GC_PROJECT_DIR + "src\\main\\java\\common\\util\\extent-config.xml";
	...
	public static final String GC_DEFAULT_FILE_DOWLOAD_LOC = "C:\\AutomationFileDownloads";
	public static final String GC_CUSTOM_OR = GC_PROJECT_DIR + "src\\test\\java\\common\\";
	public static final String GC_APK_LOC = GC_PROJECT_DIR + "Resources\\";
